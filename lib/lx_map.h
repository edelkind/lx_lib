...
#define LXM_l(n)       ((struct lx_map_opt){ LX_TYPE_LONG,   (void *)(intptr_t)(n), 10    })
#define LXM_d(n)       ((struct lx_map_opt){ LX_TYPE_INT,    (void *)(intptr_t)(n), 10    })
#define LXM_lu(n)      ((struct lx_map_opt){ LX_TYPE_ULONG,  (void *)(uintptr_t)(n), 10    })
#define LXM_du(n)      ((struct lx_map_opt){ LX_TYPE_UINT,   (void *)(uintptr_t)(n), 10    })
#define LXM_x(n)       ((struct lx_map_opt){ LX_TYPE_ULONG,  (void *)(uintptr_t)(n), 16    })
